...
import { AiMusicService } from "@/modules/ai/backend/services/ai-music.service"
...
export async function GET(request: Request) {
  try {
    ...
    if (id) {
      const data = await AiMusicService.get(id)
    ...
    const data = await AiMusicService.page(input)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function POST(request: Request) {
  try {
    ...
    const data = await AiMusicService.create(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function PUT(request: Request) {
  try {
    const body = await request.json()
    const data = await AiMusicService.update(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function DELETE(request: Request) {
  try {
    ...
    const data = await AiMusicService.delete(id)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
