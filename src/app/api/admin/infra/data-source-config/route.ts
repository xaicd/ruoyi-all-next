...
export async function GET(request: Request) {
  try {
    ...
    if (id) {
      const data = await DataSourceConfigService.get(id)
    ...
    const data = await DataSourceConfigService.page(input)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function POST(request: Request) {
  try {
    ...
    const data = await DataSourceConfigService.create(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function PUT(request: Request) {
  try {
    const body = await request.json()
    const data = await DataSourceConfigService.update(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function DELETE(request: Request) {
  try {
    ...
    const data = await DataSourceConfigService.delete(id)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
