...
import { BannerService } from "@/modules/mall/backend/services/banner.service"
...
export async function GET(request: Request) {
  try {
    ...
    if (id) {
      const data = await BannerService.get(id)
    ...
    const data = await BannerService.page(input)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function POST(request: Request) {
  try {
    ...
    const data = await BannerService.create(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function PUT(request: Request) {
  try {
    const body = await request.json()
    const data = await BannerService.update(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
