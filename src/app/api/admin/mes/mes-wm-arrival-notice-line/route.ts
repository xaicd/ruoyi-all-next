...
export async function GET(request: Request) {
  try {
    ...
    if (id) {
      const data = await MesWmArrivalNoticeLineService.get(id)
...
export async function PUT(request: Request) {
  try {
    const body = await request.json()
    const data = await MesWmArrivalNoticeLineService.update(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function DELETE(request: Request) {
  try {
    ...
    const data = await MesWmArrivalNoticeLineService.delete(id)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
