...
import { MpOpenService } from "@/modules/mp/backend/services/mp-open.service"
...
export async function GET(request: Request) {
  try {
    ...
    if (id) {
      const data = await MpOpenService.get(id)
    ...
    const data = await MpOpenService.page(input)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function POST(request: Request) {
  try {
    ...
    const data = await MpOpenService.create(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function PUT(request: Request) {
  try {
    const body = await request.json()
    const data = await MpOpenService.update(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function DELETE(request: Request) {
  try {
    ...
    const data = await MpOpenService.delete(id)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
