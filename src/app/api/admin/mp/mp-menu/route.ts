...
import { MpMenuService } from "@/modules/mp/backend/services/mp-menu.service"
...
export async function GET(request: Request) {
  try {
    ...
    if (id) {
      const data = await MpMenuService.get(id)
    ...
    const data = await MpMenuService.page(input)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function POST(request: Request) {
  try {
    ...
    const data = await MpMenuService.create(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function PUT(request: Request) {
  try {
    const body = await request.json()
    const data = await MpMenuService.update(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function DELETE(request: Request) {
  try {
    ...
    const data = await MpMenuService.delete(id)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
