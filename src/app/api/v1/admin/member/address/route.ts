...
import { AddressService } from "@/modules/member/backend/services/address.service"
...
export async function GET(request: Request) {
  try {
    ...
    const data = await AddressService.page(input)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function POST(request: Request) {
  try {
    ...
    const data = await AddressService.create(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function PUT(request: Request) {
  try {
    const body = await request.json()
    const data = await AddressService.update(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
