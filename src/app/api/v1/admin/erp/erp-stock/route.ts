...
import { ErpStockService } from "@/modules/erp/backend/services/erp-stock.service"
...
export async function GET(request: Request) {
  try {
    ...
    if (id) {
      const data = await ErpStockService.get(id)
    ...
    const data = await ErpStockService.page(input)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function POST(request: Request) {
  try {
    ...
    const data = await ErpStockService.create(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function PUT(request: Request) {
  try {
    const body = await request.json()
    const data = await ErpStockService.update(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function DELETE(request: Request) {
  try {
    ...
    const data = await ErpStockService.delete(id)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
