...
import { CrmCustomerService } from "@/modules/crm/backend/services/crm-customer.service"
...
export async function GET(request: Request) {
  try {
    ...
    if (id) {
      const data = await CrmCustomerService.get(id)
    ...
    const data = await CrmCustomerService.page(input)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function POST(request: Request) {
  try {
    ...
    const data = await CrmCustomerService.create(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function PUT(request: Request) {
  try {
    const body = await request.json()
    const data = await CrmCustomerService.update(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
