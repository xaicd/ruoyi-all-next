...
export async function GET(request: Request) {
  try {
    ...
    const data = await ImChannelMaterialManagerService.page(input)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function POST(request: Request) {
  try {
    ...
    const data = await ImChannelMaterialManagerService.create(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function PUT(request: Request) {
  try {
    const body = await request.json()
    const data = await ImChannelMaterialManagerService.update(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
