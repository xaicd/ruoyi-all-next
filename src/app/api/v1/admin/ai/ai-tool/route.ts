...
import { AiToolService } from "@/modules/ai/backend/services/ai-tool.service"
...
export async function GET(request: Request) {
  try {
    ...
    if (id) {
      const data = await AiToolService.get(id)
    ...
    const data = await AiToolService.page(input)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function POST(request: Request) {
  try {
    ...
    const data = await AiToolService.create(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function PUT(request: Request) {
  try {
    const body = await request.json()
    const data = await AiToolService.update(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function DELETE(request: Request) {
  try {
    ...
    const data = await AiToolService.delete(id)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
