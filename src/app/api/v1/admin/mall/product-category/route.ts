...
import { ProductCategoryService } from "@/modules/mall/backend/services/product-category.service"
...
export async function GET(request: Request) {
  try {
    ...
    if (id) {
      const data = await ProductCategoryService.get(id)
    ...
    const data = await ProductCategoryService.page(input)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function POST(request: Request) {
  try {
    ...
    const data = await ProductCategoryService.create(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
...
export async function PUT(request: Request) {
  try {
    const body = await request.json()
    const data = await ProductCategoryService.update(body)
    return NextResponse.json({ success: true, data })
  } catch (error: any) {
