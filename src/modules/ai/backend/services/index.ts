...
const MOCK_AI_CHATS: AiChat[] = [
  { id: "ai-chat-001", modelId: "ai-model-001", userId: "user-001", title: "产品需求分析", messageCount: 12, createdAt: "2026-08-01T10:00:00.000Z" },
  { id: "ai-chat-002", modelId: "ai-model-002", userId: "user-002", title: "代码审查助手", messageCount: 5, createdAt: "2026-08-02T14:00:00.000Z" },
]

export class AiService {
  static async listModels(input: AiPageQueryInput) {
    domainLog.event("ai.model.list", {
      page: input.page,
  ...
  static async createModel(input: AiModelCreateInput) {
    ...
    domainLog.audit("ai.model.create", {
      targetType: "AI_MODEL",
      targetId: id,
      name: input.name,
      platform: input.platform,
  ...
  static async deleteChat(input: AiChatDeleteInput) {
    ...
    domainLog.audit("ai.chat.delete", {
      targetType: "AI_CHAT",
