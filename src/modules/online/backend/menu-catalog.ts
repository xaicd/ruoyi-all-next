...
export const ONLINE_MENU_ENTRIES: SystemMenuRow[] = [
  { id: ONLINE_MENU_ID, name: "Online开发", permission: ONLINE_MENU_PERMISSION, type: "MENU", parentId: "2", path: "online-definitions", component: "infra/online-definition/index", icon: "fa:wpforms", sort: 2, status: "ACTIVE", visible: true, keepAlive: true, createdAt: "2026-08-26T00:00:00.000Z", updatedAt: "2026-08-26T00:00:00.000Z" },
