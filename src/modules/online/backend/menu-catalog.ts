...
export const ONLINE_MENU_ENTRIES: SystemMenuRow[] = [
  { id: ONLINE_MENU_ID, name: "Online 开发", permission: ONLINE_MENU_PERMISSION, type: "MENU", parentId: "2", path: "online-definitions", component: "infra/online-definition/index", icon: "fa:wpforms", sort: 2, status: "ACTIVE", visible: true, keepAlive: true, createdAt: "2026-08-26T00:00:00.000Z", updatedAt: "2026-08-26T00:00:00.000Z" },
  { id: ONLINE_TEST_MENU_ID, name: "Online 测试", permission: "infra:online-definition:test", type: "MENU", parentId: "2", path: "online-test", component: "infra/online-test/index", icon: "ep:aim", sort: 3, status: "ACTIVE", visible: true, keepAlive: true, createdAt: "2026-08-29T00:00:00.000Z", updatedAt: "2026-08-29T00:00:00.000Z" },
