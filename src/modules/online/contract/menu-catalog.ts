...
export const ONLINE_MENU_ENTRIES: OnlineMenuCatalogRow[] = [
  { id: ONLINE_MENU_ID, name: "在线建模", permission: ONLINE_MENU_PERMISSION, type: "MENU", parentId: "2", path: "online-definitions", component: "infra/online-definition/index", icon: "fa:wpforms", sort: 2, status: "ACTIVE", visible: true, keepAlive: true, createdAt: "2026-08-26T00:00:00.000Z", updatedAt: "2026-08-26T00:00:00.000Z" },
  { id: ONLINE_TEST_MENU_ID, name: "动态报表", permission: "report:custom-sql:execute", type: "MENU", parentId: "2", path: "online-test", component: "infra/online-test/index", icon: "ep:aim", sort: 3, status: "ACTIVE", visible: true, keepAlive: true, createdAt: "2026-08-29T00:00:00.000Z", updatedAt: "2026-08-29T00:00:00.000Z" },
  ...
  { id: "online-114-test", name: "功能测试", permission: "infra:online-definition:test", type: "BUTTON", parentId: ONLINE_MENU_ID, path: null, component: null, icon: null, sort: 6, status: "ACTIVE", visible: true, keepAlive: true, createdAt: "2026-08-26T00:00:00.000Z", updatedAt: "2026-08-26T00:00:00.000Z" },
