...
export const ADMIN_MENU: AdminMenuItem[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        requiredPermission: PERMISSIONS.SYSTEM_LOGIN_LOG_QUERY,
      },
      {
        key: "operate-logs",
        label: "操作日志",
        path: "/admin/system/operate-logs",
        requiredPermission: PERMISSIONS.SYSTEM_OPERATE_LOG_QUERY,
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: "访问日志",
        path: "/admin/infra/api-access-log",
        requiredPermission: PERMISSIONS.INFRA_API_ACCESS_LOG_QUERY,
      },
      {
        key: "infra-api-error-logs",
        label: "错误日志",
        path: "/admin/infra/api-error-logs",
        requiredPermission: PERMISSIONS.INFRA_API_ERROR_LOG_QUERY,
      },
      {
        key: "infra-redis",
        label: "Redis监控",
